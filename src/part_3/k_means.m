...
max_iterations = 40; % if this number is too low a warning will be displayed stating that the algorithm did not converge, which you should expect since the software only implemented one iteration.
...
plot(X(indices==2,1),X(indices==2,2),'b.','MarkerSize',12)
plot(X(indices==3,1),X(indices==3,2),'g.','MarkerSize',12)
plot(X(indices==4,1),X(indices==4,2),'y.','MarkerSize',12)
plot(centroids(:,1),centroids(:,2),'k*','MarkerSize',15,'LineWidth',3) 
...
plot(X(indices==3,1),X(indices==3,2),'g.','MarkerSize',12)
plot(X(indices==4,1),X(indices==4,2),'y.','MarkerSize',12)
plot(X(indices==5,1),X(indices==5,2),'m.','MarkerSize',12)
plot(centroids(:,1),centroids(:,2),'k*','MarkerSize',15,'LineWidth',3) 
